...
pub use cache_render::{
    ...
    evict_render_cache_by_hash, evict_render_cache_for_content, get_cached_path, is_mermaid_lang,
...
pub(crate) static SVG_FONT_DB_PREWARM_STARTED: OnceLock<()> = OnceLock::new();
...
// Wired as direct children (not nested under a `mermaid_tests` module) so
// `super::` in the test files resolves to this module.
#[cfg(test)]
#[path = "mermaid_tests/part_01.rs"]
mod mermaid_tests_part_01;
#[cfg(test)]
#[path = "mermaid_tests/part_02.rs"]
mod mermaid_tests_part_02;
