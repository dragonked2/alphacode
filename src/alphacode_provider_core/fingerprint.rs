...
/// normalization, not the high-level Alphacode message list. Do not include volatile transport
...
pub fn log_provider_canonical_input(
    ...
    let log_context = crate::alphacode_logging::current_context_snapshot();
