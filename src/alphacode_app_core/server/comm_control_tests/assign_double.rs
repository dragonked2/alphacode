...
fn active_assignment_conflict_detects_only_assigned_and_fresh_items() {
    ...
    let progress_with_heartbeat = |heartbeat: Option<u64>| crate::alphacode_app_core::server::SwarmTaskProgress {
    ...
    let just_assigned = crate::alphacode_app_core::server::SwarmTaskProgress {
        assigned_session_id: Some("snail".to_string()),
...
fn double_assign_fixture(
    ...
    intruder: &str,
    contested: PlanItem,
    progress: crate::alphacode_app_core::server::SwarmTaskProgress,
) -> (
