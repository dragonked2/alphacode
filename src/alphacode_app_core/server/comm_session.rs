...
use crate::alphacode_app_core::config::SwarmSpawnMode;
...
/// (`ALPHACODE_SPAWN_KIND`, swarm/coordinator ids, ...) to spawn hooks and
    ...
    let visible_spawn = match resolved_spawn_mode {
        ...
        SwarmSpawnMode::Visible | SwarmSpawnMode::Auto => prepare_visible_spawn_session(
            ...
            |session_id, cwd, selfdev_requested, provider_key| {
                ...
                // and terminals can identify and reroute it (ALPHACODE_SPAWN_*).
                let context = crate::session_launch::SessionSpawnContext::kind("swarm-agent")
                    .env("ALPHACODE_SPAWN_SWARM_ID", swarm_id)
                    .env("ALPHACODE_SPAWN_COORDINATOR_SESSION_ID", req_session_id)
