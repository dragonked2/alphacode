...
use crate::alphacode_app_core::bus::Bus;
...
use crate::alphacode_app_core::session::{Session, SessionStatus};
...
async fn send_history_from_persisted_session(
    ...
    let history_event = ServerEvent::History {
        ...
        server_version: Some(crate::alphacode_build_meta::version().to_string()),
