...
impl Agent {
    ...
    pub(super) fn build_env_snapshot(
        ...
        let (alphacode_git_hash, alphacode_git_dirty) = match detail {
            EnvSnapshotDetail::Full => ALPHACODE_REPO_SOURCE_STATE.clone(),
        ...
        EnvSnapshot {
            ...
            alphacode_version: crate::alphacode_build_meta::version().to_string(),
            alphacode_git_hash,
            alphacode_git_dirty,
