...
impl Agent {
    ...
    pub fn model_catalog_snapshot(&self) -> crate::alphacode_provider_core::ModelCatalogSnapshot {
    ...
    pub fn active_resolved_credential(&self) -> Option<crate::alphacode_provider_core::ResolvedCredential> {
