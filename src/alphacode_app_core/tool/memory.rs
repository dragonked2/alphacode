...
use crate::alphacode_app_core::memory::{MemoryCategory, MemoryEntry, MemoryManager, MemoryScope};
use anyhow::Result;
...
impl Tool for MemoryTool {
    ...
    async fn execute(&self, input: Value, ctx: ToolContext) -> Result<ToolOutput> {
        use crate::alphacode_app_core::memory;
        use crate::alphacode_app_core::memory_types::{MemoryEventKind, MemoryState};
...
mod tests {
    ...
    async fn project_scope_round_trips_with_working_dir() {
        ...
        crate::alphacode_core::env::set_var("ALPHACODE_HOME", home.path());
