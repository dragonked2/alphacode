...
impl Tool for WriteTool {
    ...
    fn description(&self) -> &str {
        "Create or overwrite a file with the given content. Use this to create new files or completely replace existing file contents. For partial changes, use the edit tool instead. Always verify the file was written correctly after use."
    }
