...
use crate::alphacode_app_core::protocol::SwarmMemberStatus;
use crate::alphacode_app_core::session::{StoredReplayEvent, StoredReplayEventKind};
...
fn test_load_swarm_sessions_discovers_related_sessions() {
    ...
    let temp_home = tempfile::Builder::new()
        .prefix("alphacode-replay-swarm-test-")
        .tempdir()
        .expect("create temp ALPHACODE_HOME");
