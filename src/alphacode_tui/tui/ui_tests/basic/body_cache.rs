...
fn test_build_body_from_base_rerenders_stale_mermaid_pending_tail() {
    ...
    let live_epoch = crate::alphacode_tui::tui::mermaid::deferred_render_epoch();
    ...
    assert!(
        rebuilt.mermaid_pending_epoch.is_none()
            || rebuilt.mermaid_pending_epoch == Some(crate::alphacode_tui::tui::mermaid::deferred_render_epoch()),
...
fn test_build_body_from_base_keeps_current_mermaid_pending_base() {
    ...
    let mut base = super::prepare::prepare_body(&state, width, false);
    base.mermaid_pending_epoch = Some(crate::alphacode_tui::tui::mermaid::deferred_render_epoch());
...
fn test_prepare_body_anchors_tool_image_after_tool_message() {
    ...
    assert_eq!(region.render, crate::alphacode_tui_messages::ImageRegionRender::Fit);
...
fn test_prepare_body_incremental_anchors_image_on_new_tool_message() {
    ...
    assert_eq!(
        ...
        crate::alphacode_tui_messages::ImageRegionRender::Fit
    );
