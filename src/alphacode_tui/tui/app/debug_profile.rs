...
impl App {
    pub(in crate::alphacode_tui::tui::app) fn runtime_memory_profile(&self) -> serde_json::Value {
        self.memory_profile_value(false)
    }

    pub(in crate::alphacode_tui::tui::app) fn debug_memory_profile(&self) -> serde_json::Value {
    ...
    fn memory_profile_value(&self, include_history: bool) -> serde_json::Value {
        ...
        let markdown = crate::alphacode_tui::tui::markdown::debug_memory_profile();
        let mermaid = crate::alphacode_tui::tui::mermaid::debug_memory_profile();
        let visual_debug = crate::alphacode_tui::tui::visual_debug::debug_memory_profile();
        let ui_render = crate::alphacode_tui::tui::ui::debug_memory_profile();
        let side_panel_render = crate::alphacode_tui::tui::ui::debug_side_panel_memory_profile();
        let mcp = self
            .mcp_manager
            .try_read()
        ...
        let transcript_memory = crate::alphacode_tui::tui::transcript_memory_profile(
            &self.session,
            &self.messages,
