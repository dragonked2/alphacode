...
impl App {
    ...
    pub(super) fn show_todo_card(&mut self) {
        ...
        self.push_display_message(crate::alphacode_tui::tui::DisplayMessage::todos(content));
...
pub(super) fn todos_view_status_message(app: &App) -> String {
    format!(
        ...
        crate::alphacode_tui::tui::keybind::todo_card_key_label(),
    ...
    match arg {
        ...
        "pin" | "pin on" | "pin off" => {
            ...
            match crate::config::Config::set_pin_todos(enabled) {
                Ok(()) => app.push_display_message(crate::alphacode_tui::tui::DisplayMessage::system(
                    if enabled {
                ...
                Err(error) => app.push_display_message(crate::alphacode_tui::tui::DisplayMessage::error(
        ...
        _ => {
            app.push_display_message(crate::alphacode_tui::tui::DisplayMessage::error(
