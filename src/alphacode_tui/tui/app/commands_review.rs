...
use crate::alphacode_tui::message::{ContentBlock, Role, ToolCall};
...
pub(super) fn preferred_one_shot_review_override() -> Option<(String, String)> {
    let creds = crate::alphacode_base::auth::codex::load_credentials().ok()?;
...
// The `issue_605_clear_side_panel` tests live in `tests/mod.rs` (via
