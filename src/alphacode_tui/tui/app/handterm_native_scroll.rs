...
impl App {
    ...
    fn current_native_scroll_snapshot(&self) -> PaneSnapshot {
        ...
        if let Some(layout) = crate::alphacode_tui::tui::ui::last_layout_snapshot() {
                ...
                && let Some(area) = layout.diff_pane_area
            {
                ...
                panes.push(PaneState {
                    ...
                    width: area.width,
                    height: area.height,
                    position: crate::alphacode_tui::tui::ui::last_diff_pane_effective_scroll(),
                    content_length,
                    viewport_length: viewport,
                });
            }
...
fn spawn_bridge_thread(
    ...
    match thread::Builder::new()
        .name("alphacode-handterm-scroll".to_string())
...
mod bridge_tests {
    ...
    fn unique_socket_path(label: &str) -> PathBuf {
        ...
        std::env::temp_dir().join(format!(
            "alphacode-handterm-{label}-{}-{nonce:x}.sock",
            std::process::id()
        ))
    }
