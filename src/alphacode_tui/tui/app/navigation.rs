use super::*;
use crate::alphacode_tui::tui::ui::input_ui;
...
fn tui_mouse_scroll_trace_enabled() -> bool {
    std::env::var_os("ALPHACODE_TUI_SCROLL_TRACE").is_some()
}
...
impl App {
    ...
    const MOUSE_SCROLL_MAX_INTENT_LINES: i16 = 3;
    ...
    const MOUSE_SCROLL_MAX_QUEUE: i16 = 15;
    ...
    pub(super) fn toggle_swarm_message_expand(&mut self, msg_idx: usize) -> bool {
        ...
        let expanded = crate::alphacode_tui_messages::parse_collapsible_swarm_content(&toggled)
    ...
    pub(super) fn normalize_diagram_state(&mut self) {
        ...
        let diagram_count = crate::alphacode_tui::tui::mermaid::get_active_diagrams().len();
        if diagram_count == 0 {
            self.diagram_focus = false;
            self.diagram_index = 0;
            self.diagram_scroll_x = 0;
    ...
    pub(super) fn toggle_inline_images(&mut self) {
        ...
        self.set_status_notice(if self.inline_images_visible {
            ...
            let alt = crate::alphacode_tui_core::keybind::alt_chord("Shift+I");
    ...
    pub(super) fn toggle_diagram_pane_position(&mut self) {
        use crate::alphacode_tui::config::DiagramPanePosition;
