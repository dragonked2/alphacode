use crate::alphacode_tui::protocol::NotificationType;
use crate::alphacode_tui::tui::ui::capitalize;
    ...
    match notification_type {
        NotificationType::Message { scope, channel, .. } => match scope.as_deref() {
            ...
            Some("swarm_await") => SwarmNotificationPresentation {
                ...
                message: crate::alphacode_tui::tui::ui::compact_swarm_await_summary(trimmed),
        ...
        NotificationType::FileConflict {
            ...
            SwarmNotificationPresentation {
                ...
                message: if has_details {
                    crate::alphacode_tui_messages::encode_collapsible_swarm_content(
                        &summary_line,
                        &detail_body,
                    )
                } else {
...
mod tests {
    ...
    fn present_swarm_notification_formats_file_activity_with_compact_path_and_preview() {
        let presentation = present_swarm_notification(
            "moss",
            &NotificationType::FileConflict {
                path: "/home/jeremy/alphacode/src/tool/communicate.rs".to_string(),
            ...
            "⚠ File activity: /home/jeremy/alphacode/src/tool/communicate.rs - moss just edited this file you previously worked with: edited lines 323-348 (1 occurrence)",
            false,
        );
        ...
        assert_eq!(
            presentation.status_notice,
            "File activity · …/alphacode/src/tool/communicate.rs"
        );
    }
