...
fn reasoning_region_closes_before_normal_output() {
    ...
    with_reasoning_current_home(|| {
        ...
        assert!(
            !answer_line.contains(crate::alphacode_tui_markdown::REASONING_SENTINEL),
...
fn reasoning_region_renders_dim_italic_text_without_gutter() {
    ...
    let lines = crate::alphacode_tui::tui::markdown::render_markdown_with_width(&reasoning_content, Some(80));
    let body = lines
        .iter()
        .find(|l| {
            l.spans
    ...
    assert!(
        !rendered.contains(crate::alphacode_tui_markdown::REASONING_SENTINEL),
...
fn strip_reasoning_lines_removes_reasoning_keeps_answer() {
    use crate::alphacode_tui::tui::app::input::strip_reasoning_lines;
    ...
    content.push_str(&crate::alphacode_tui_markdown::reasoning_line_markup("thinking one"));
    content.push_str(&crate::alphacode_tui_markdown::reasoning_line_markup("thinking two"));
    content.push('\n');
    content.push_str("Here is the answer.\n");

    let stripped = strip_reasoning_lines(&content);
    assert_eq!(stripped, "Here is the answer.");
    assert!(!stripped.contains(crate::alphacode_tui_markdown::REASONING_SENTINEL));
}
...
fn strip_reasoning_lines_reasoning_only_becomes_empty() {
    ...
    let mut content = String::new();
    content.push_str(&crate::alphacode_tui_markdown::reasoning_line_markup("only thinking"));
    let stripped = strip_reasoning_lines(&content);
...
fn multiple_reasoning_blocks_anchor_in_order_and_clear_next_prompt() {
    // Hermetic ALPHACODE_HOME: these assertions depend on the default
    ...
    with_reasoning_current_home(|| {
        ...
        assert!(
            !app.streaming_text()
                .contains(crate::alphacode_tui_markdown::REASONING_SENTINEL),
...
fn anchored_trace_never_moves_and_clears_on_next_prompt() {
    ...
    // not leaking in from the developer's real ~/.alphacode (other tests
...
fn gc_dissolves_stale_traces_only_when_provably_offscreen() {
    ...
    with_reasoning_current_home(|| {
        ...
        crate::alphacode_tui::tui::ui::set_last_total_wrapped_lines(10);
        app.open_reasoning_region();
        app.append_reasoning_text("old thought\n");
        app.close_reasoning_region(None);

        crate::alphacode_tui::tui::ui::set_last_total_wrapped_lines(40);
        app.open_reasoning_region();
        ...
        crate::alphacode_tui::tui::ui::set_last_total_wrapped_lines(25);
...
fn gc_never_runs_while_user_scrolled_up() {
    ...
    with_reasoning_current_home(|| {
        ...
        crate::alphacode_tui::tui::ui::set_last_total_wrapped_lines(200);
...
fn gc_keeps_single_trace_indefinitely() {
    ...
    with_reasoning_current_home(|| {
        ...
        crate::alphacode_tui::tui::ui::set_last_total_wrapped_lines(500);
        assert!(!app.gc_offscreen_reasoning_traces());
