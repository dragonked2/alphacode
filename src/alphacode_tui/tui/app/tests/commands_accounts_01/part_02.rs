...
#[test]
fn test_subscription_command_shows_alphacode_status_scaffold() {
    let _guard = crate::storage::lock_test_env();
    crate::subscription_catalog::clear_runtime_env();
    crate::alphacode_core::env::remove_var(crate::subscription_catalog::ALPHACODE_API_KEY_ENV);
    crate::alphacode_core::env::remove_var(crate::subscription_catalog::ALPHACODE_API_BASE_ENV);
    ...
    assert_eq!(msg.role, "system");
    assert!(msg.content.contains("Alphacode Subscription Status"));
    assert!(msg.content.contains("/login alphacode"));
...
fn test_subscribe_command_shows_pitch_with_plans_and_next_step() {
    ...
    assert_eq!(msg.role, "system");
    assert!(msg.content.contains("Subscribe to alphacode"));
...
fn test_usage_command_requests_usage_report_with_inline_view() {
    ...
    assert!(commands::handle_usage_command(&mut app, "/usage"));
