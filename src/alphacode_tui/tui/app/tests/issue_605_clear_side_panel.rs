...
fn clear_side_panel_for_new_session_drops_pages_and_focus() {
    ...
    crate::alphacode_tui::tui::app::commands_review::clear_side_panel_for_new_session(&mut app);
...
fn reset_current_session_also_clears_the_side_panel() {
    ...
    crate::alphacode_tui::tui::app::commands_review::reset_current_session(&mut app);
