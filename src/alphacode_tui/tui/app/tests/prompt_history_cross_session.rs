...
fn test_prompt_history_file_roundtrip_dedupes_and_caps() {
    ...
    crate::alphacode_tui::tui::app::prompt_history::append_to_path(&path, "one");
    crate::alphacode_tui::tui::app::prompt_history::append_to_path(&path, "two");
    crate::alphacode_tui::tui::app::prompt_history::append_to_path(&path, "one"); // repeat

    let loaded = crate::alphacode_tui::tui::app::prompt_history::load_from_path(&path);
    ...
    crate::alphacode_tui::tui::app::prompt_history::append_to_path(&path, "multi\nline\nprompt");
    let loaded = crate::alphacode_tui::tui::app::prompt_history::load_from_path(&path);
