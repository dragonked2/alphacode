...
fn test_remote_auth_activity_notification_is_status_only_during_onboarding() {
    let mut app = create_test_app();
    let mut flow = crate::alphacode_tui::tui::app::onboarding_flow::OnboardingFlow::begin();
    flow.phase = crate::alphacode_tui::tui::app::onboarding_flow::OnboardingPhase::Login { import: None };
...
fn test_model_picker_remote_comtegra_model_uses_comtegra_route_not_copilot() {
    ...
    crate::alphacode_core::env::set_var("COMTEGRA_API_KEY", "test-key");
    ...
    match prev_key {
        Some(value) => crate::alphacode_core::env::set_var("COMTEGRA_API_KEY", value),
        None => crate::alphacode_core::env::remove_var("COMTEGRA_API_KEY"),
    }
...
fn test_model_picker_remote_bedrock_model_has_bedrock_route_when_configured() {
    ...
    let prev_home = std::env::var("ALPHACODE_HOME").ok();
    ...
    crate::alphacode_core::env::set_var("ALPHACODE_HOME", temp.path().display().to_string());
    crate::alphacode_core::env::set_var(crate::provider::bedrock::API_KEY_ENV, "test-bedrock-key");
    crate::alphacode_core::env::set_var(crate::provider::bedrock::REGION_ENV, "us-east-2");
    ...
    match prev_key {
        Some(value) => crate::alphacode_core::env::set_var(crate::provider::bedrock::API_KEY_ENV, value),
        None => crate::alphacode_core::env::remove_var(crate::provider::bedrock::API_KEY_ENV),
    }
    match prev_region {
        Some(value) => crate::alphacode_core::env::set_var(crate::provider::bedrock::REGION_ENV, value),
        None => crate::alphacode_core::env::remove_var(crate::provider::bedrock::REGION_ENV),
    }
    crate::alphacode_base::auth::AuthStatus::invalidate_cache();
