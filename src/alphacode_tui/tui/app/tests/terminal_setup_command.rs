...
// Shift+Enter becomes `ESC[13;2u`. alphacode requests that protocol at startup and
...
//  2. Once decoded, alphacode inserts a newline instead of submitting.
//
...
fn shift_enter_csi_u_sequence_decodes_to_enter_plus_shift() {
    ...
    let sequence = crate::alphacode_tui::tui::terminal_setup::SHIFT_ENTER_CSI_U;
...
fn terminal_setup_is_offered_in_the_command_palette() {
    ...
    let (_, help) = crate::alphacode_tui::tui::app::registered_command_entries()
