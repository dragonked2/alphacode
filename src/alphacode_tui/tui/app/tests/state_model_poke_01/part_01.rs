...
fn test_strip_oversized_images_drops_oldest_first() {
    use crate::alphacode_tui::message::ContentBlock;
...
fn test_diagram_cycle_ctrl_arrows() {
    ...
    crate::alphacode_tui::tui::mermaid::register_active_diagram(0x1, 100, 80, None);
    crate::alphacode_tui::tui::mermaid::register_active_diagram(0x2, 120, 90, None);
    crate::alphacode_tui::tui::mermaid::register_active_diagram(0x3, 140, 100, None);
...
fn test_pinned_side_diagram_layout_allocates_right_pane() {
    ...
    let frame = crate::alphacode_tui::tui::visual_debug::latest_frame().expect("frame capture");
...
fn test_side_pane_scroll_by_clamps_to_rendered_extent() {
    ...
    crate::alphacode_tui::tui::ui::set_pinned_pane_total_lines(30);
    crate::alphacode_tui::tui::ui::set_last_diff_pane_max_scroll(10);
    crate::alphacode_tui::tui::ui::set_last_diff_pane_effective_scroll(10);
