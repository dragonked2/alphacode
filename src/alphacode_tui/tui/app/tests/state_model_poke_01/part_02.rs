...
fn test_mouse_scroll_over_tool_side_panel_updates_visible_render() {
    ...
    assert!(crate::alphacode_tui::tui::ui::pinned_pane_total_lines() > 3);
    ...
    assert_eq!(crate::alphacode_tui::tui::ui::last_diff_pane_effective_scroll(), 3);
    assert_ne!(
        before, after,
...
fn test_tool_side_panel_uses_shared_right_pane_keyboard_focus() {
    ...
    assert!(input::handle_navigation_shortcuts(
        &mut app,
        KeyCode::Char('g'),
        KeyModifiers::ALT
    ));
