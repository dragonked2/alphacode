...
pub(in crate::alphacode_tui::tui::app) async fn begin_remote_send(
    app: &mut App,
...
pub(in crate::alphacode_tui::tui::app) fn restore_prepared_remote_input(
    app: &mut App,
...
pub(in crate::alphacode_tui::tui::app) async fn submit_prepared_remote_input(
    app: &mut App,
    remote: &mut RemoteConnection,
    prepared: input::PreparedInput,
) -> Result<()> {
...
/// the sending state.
pub(in crate::alphacode_tui::tui::app) async fn submit_remote_slash_input(
    app: &mut App,
    remote: &mut RemoteConnection,
    prepared: input::PreparedInput,
) -> Result<()> {
...
pub(in crate::alphacode_tui::tui::app) async fn route_prepared_input_to_new_remote_session(
    app: &mut App,
    remote: &mut RemoteConnection,
    prepared: input::PreparedInput,
) -> Result<()> {
...
pub(in crate::alphacode_tui::tui::app) fn begin_remote_split_launch(app: &mut App, label: &str) {
    app.is_processing = true;
    app.status = ProcessingStatus::Sending;
    app.status_detail = None;
...
pub(in crate::alphacode_tui::tui::app) fn finish_remote_split_launch(app: &mut App) {
...
pub(in crate::alphacode_tui::tui::app) fn apply_transcript_event(
    app: &mut App,
    text: String,
    mode: TranscriptMode,
) {
...
pub(in crate::alphacode_tui::tui::app) async fn apply_remote_transcript_event(
    app: &mut App,
    remote: &mut RemoteConnection,
    text: String,
    mode: TranscriptMode,
