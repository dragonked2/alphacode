use crate::alphacode_tui::plan::PlanItem;
use crate::alphacode_tui::protocol::PlanGraphStatus;
...
mod tests {
    ...
    fn swarm_plan_status_notice_deep_mode_surfaces_low_confidence_ids() {
        ...
        // in alphacode-protocol): completed items with shaky self-reported coverage.
        let mut summary = summary_fixture();
