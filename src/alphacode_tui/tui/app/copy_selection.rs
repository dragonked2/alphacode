...
impl App {
    ...
    pub(super) fn normalized_copy_selection(&self) -> Option<crate::alphacode_tui::tui::CopySelectionRange> {
        ...
        if (anchor.abs_line, anchor.column) <= (cursor.abs_line, cursor.column) {
            Some(crate::alphacode_tui::tui::CopySelectionRange {
                start: anchor,
                end: cursor,
            })
        } else {
    ...
    fn clamp_point(
        mut point: crate::alphacode_tui::tui::CopySelectionPoint,
    ...
    fn preferred_copy_pane(&self) -> crate::alphacode_tui::tui::CopySelectionPane {
        self.current_copy_selection_pane()
            .or_else(|| {
                self.diff_pane_focus
                    .then_some(crate::alphacode_tui::tui::CopySelectionPane::SidePane)
            })
    ...
    fn first_visible_copy_point(
        ...
        crate::alphacode_tui::tui::ui::copy_pane_first_visible_point(pane)
    }

    fn default_copy_point(&self) -> Option<crate::alphacode_tui::tui::CopySelectionPoint> {
        self.copy_selection_cursor
            .or(self.copy_selection_anchor)
    ...
    fn collapse_selection_to(&mut self, point: crate::alphacode_tui::tui::CopySelectionPoint) {
    ...
    fn extend_selection_to(&mut self, point: crate::alphacode_tui::tui::CopySelectionPoint) {
        self.note_copy_selection_activity(point.pane);
    ...
    fn move_copy_selection_to_document_edge(&mut self, end: bool, extend: bool) -> bool {
        ...
        let point = crate::alphacode_tui::tui::CopySelectionPoint {
            pane,
            abs_line,
            column: if end {
    ...
    pub(super) fn select_all_in_copy_mode(&mut self) -> bool {
        ...
        self.copy_selection_anchor = Some(crate::alphacode_tui::tui::CopySelectionPoint {
            pane,
            abs_line: 0,
            column: 0,
        });
        let last_line = line_count - 1;
        let end_point = crate::alphacode_tui::tui::CopySelectionPoint {
            pane,
            abs_line: last_line,
    ...
    pub(super) fn select_chat_viewport_context(&mut self) -> bool {
        ...
        let end_point = crate::alphacode_tui::tui::CopySelectionPoint {
            pane: crate::alphacode_tui::tui::CopySelectionPane::Chat,
            abs_line: end_line,
            column: crate::alphacode_tui::tui::ui::copy_viewport_line_text(end_line)
                .map(|text| UnicodeWidthStr::width(text.as_str()))
                .unwrap_or(0),
        };
        self.copy_selection_cursor = Some(end_point);
        self.copy_selection_goal_column = Some(end_point.column);
        self.note_copy_selection_activity(crate::alphacode_tui::tui::CopySelectionPane::Chat);
        true
    }
    ...
    fn scroll_copy_selection_pane(
        ...
        match pane {
            ...
            crate::alphacode_tui::tui::CopySelectionPane::Input => return false,
        }
        true
    }
    ...
    where
        F: FnOnce(&str) -> bool,
    {
        let point = crate::alphacode_tui::tui::ui::copy_point_from_screen(mouse.column, mouse.row);
        match mouse.kind {
