...
impl App {
    pub(in crate::alphacode_tui::tui::app) fn build_debug_snapshot(&self) -> DebugSnapshot {
    ...
    pub(in crate::alphacode_tui::tui::app) fn handle_assertions(&mut self, raw: &str) -> String {
    ...
    pub(in crate::alphacode_tui::tui::app) fn handle_script_run(&mut self, raw: &str) -> String {
    ...
    pub(in crate::alphacode_tui::tui::app) fn handle_test_script(
        &mut self,
        script: crate::alphacode_tui::tui::test_harness::TestScript,
    ) -> String {
        use crate::alphacode_tui::tui::test_harness::TestStep;
    ...
    pub(in crate::alphacode_tui::tui::app) fn apply_wait_ms(&mut self, wait_ms: u64) -> String {
    ...
    pub(in crate::alphacode_tui::tui::app) fn check_debug_command(&mut self) -> Option<String> {
    ...
    pub(in crate::alphacode_tui::tui::app) fn parse_key_spec(
        &self,
        key_spec: &str,
    ...
    pub(in crate::alphacode_tui::tui::app) fn parse_and_inject_key(
        &mut self,
        key_spec: &str,
