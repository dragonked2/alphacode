...
/// Bedrock vendor namespaces alphacode knows how to render.
///
...
mod tests {
    ...
    fn dump_pretty_model_names_for_manual_audit() {
        ...
        for list in [
            ...
            crate::alphacode_provider_core::ALL_OPENAI_MODELS,
            crate::alphacode_provider_core::OPENAI_API_ONLY_PRO_MODELS,
        ] {
