...
impl App {
    ...
    pub(super) fn request_usage_report(&mut self) {
        use crate::alphacode_tui::bus::{Bus, BusEvent};
    ...
    pub(super) fn update_cost_impl(&mut self) {
        ...
        let pinned_anthropic = crate::alphacode_provider_core::pinned_mode_for(
            crate::alphacode_provider_core::DualAuthProvider::Anthropic,
            runtime_provider.as_deref(),
        );
        let pinned_openai = crate::alphacode_provider_core::pinned_mode_for(
