...
use crate::alphacode_tui::tui::app::{App, DisplayMessage};
...
impl App {
    ...
    pub(in crate::alphacode_tui::tui::app) fn open_reasoning_region(&mut self) {
    ...
    pub(in crate::alphacode_tui::tui::app) fn strip_reasoning_partial_tail(&mut self) {
    ...
    pub(in crate::alphacode_tui::tui::app) fn append_reasoning_text(&mut self, text: &str) {
        if text.is_empty() {
            return;
        }
        if !self.reasoning_streaming {
        ...
        for ch in text.chars() {
            if ch == '\n' {
                ...
                committed.push_str(&crate::alphacode_tui_markdown::reasoning_line_markup(&line));
            } else {
    ...
    /// ephemeral reasoning).
    pub(in crate::alphacode_tui::tui::app) fn reasoning_current_mode(&self) -> bool {
        matches!(
    ...
    /// the turn's traces.
    pub(in crate::alphacode_tui::tui::app) fn anchor_current_reasoning_block(&mut self) {
        ...
        self.turn_reasoning_traces
            .push(crate::alphacode_tui::tui::app::TurnReasoningTrace {
                ...
                wrapped_lines_at_anchor: crate::alphacode_tui::tui::ui::last_total_wrapped_lines(),
            });
    ...
    /// reflows anyway).
    pub(in crate::alphacode_tui::tui::app) fn clear_turn_reasoning_traces(&mut self) {
