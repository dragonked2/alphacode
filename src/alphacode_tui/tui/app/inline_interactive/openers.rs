        ...
        let mut models = providers
            ...
            .map(|provider| {
                ...
                let state_label = match auth_state {
                    ...
                    crate::alphacode_base::auth::AuthState::Expired => "attention",
                    crate::alphacode_base::auth::AuthState::NotConfigured => "setup",
                };
                PickerEntry {
                    ...
                    selected_option: 0,
                    is_current: auth_state == crate::alphacode_base::auth::AuthState::Available,
                    is_default: false,
                    is_favorite: false,
