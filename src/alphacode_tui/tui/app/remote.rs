...
async fn apply_terminal_event(
    ...
    let mut input_attribution = crate::alphacode_tui::tui::ui::FrameInputAttribution {
        event: None,
        scroll_delta: None,
        model_picker_open: app
            .inline_interactive_state
    ...
    match event {
        ...
        Some(Ok(Event::Key(key))) => {
            ...
            crate::alphacode_tui::tui::ui::note_key_event_read();
    ...
    crate::alphacode_tui::tui::ui::set_frame_input_attribution(input_attribution);
    Ok(needs_redraw)
}
...
fn auth_changed_event_for_login_provider(provider: &str) -> Option<crate::protocol::AuthChanged> {
    ...
    let api_key_login = descriptor
        .map(|descriptor| {
            use crate::alphacode_tui::provider_catalog::LoginProviderAuthKind;
            matches!(
