...
use crate::alphacode_tui::replay::{PaneReplayInput, ReplayEvent, TimelineEvent};
use crate::alphacode_tui::tui::backend::{RemoteEventState, ReplayRemoteState};
use anyhow::Result;
...
impl SwarmReplayPane {
    ...
    fn render_buffer(&self, width: u16, height: u16) -> Result<Buffer> {
        ...
        terminal.draw(|frame| crate::alphacode_tui::tui::render_frame(frame, &self.app))?;
...
fn draw_swarm_replay_frame(frame: &mut Frame<'_>, panes: &mut [SwarmReplayPane], sim_time_ms: f64) {
    ...
    crate::alphacode_tui::tui::color_support::clear_buf(area, frame.buffer_mut());
...
mod tests {
    ...
    use crate::alphacode_tui::replay::{ReplayEvent, TimelineEvent, TimelineEventKind};
