...
pub use crate::alphacode_tui_core::keybind::{
...
use crate::alphacode_tui_core::keybind::{
...
// so the rest of the TUI can reach it via `crate::alphacode_tui::tui::keybind::*`.
#[allow(unused_imports)]
pub use crate::alphacode_config_types::keybindings::{
...
/// Optional binding that spawns a fresh alphacode session in a new terminal window.
