use crate::alphacode_tui::message::{ContentBlock, Message};
use crate::alphacode_tui::session::Session;
use crate::alphacode_tui::side_panel::SidePanelSnapshot;
...
mod tests {
    ...
    fn transcript_memory_profile_breaks_out_provider_display_and_side_panel() {
        ...
        let display_messages = crate::alphacode_tui::tui::display_messages_from_session(&session);
