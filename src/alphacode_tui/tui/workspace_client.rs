use crate::alphacode_tui::session::{Session, SessionStatus};
use crate::alphacode_tui::tui::workspace_map::{
...
/// [`crate::alphacode_tui::tui::app::App`] so each client instance carries its own workspace
