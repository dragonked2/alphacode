...
impl SessionPicker {
    ...
    pub(super) fn session_is_claude_code(session: &SessionInfo) -> bool {
        crate::alphacode_tui_session_picker::session_is_claude_code(session.source, &session.id)
    }
    ...
    pub(super) fn session_is_pi(session: &SessionInfo) -> bool {
        crate::alphacode_tui_session_picker::session_is_pi(
            session.source,
    ...
    pub(super) fn session_is_open_code(session: &SessionInfo) -> bool {
        crate::alphacode_tui_session_picker::session_is_open_code(
            session.source,
            session.provider_key.as_deref(),
        )
    }
