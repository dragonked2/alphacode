...
use crate::alphacode_tui::protocol::{AuthChanged, FeatureToggle, Request, ServerEvent};
use crate::alphacode_tui::server;
use crate::alphacode_tui::transport::{Stream, WriteHalf};
...
/// Remote connection to alphacode server
...
impl RemoteConnection {
    ...
    pub async fn connect_with_session(
        ...
        if std::env::var_os("ALPHACODE_REMOTE_BOOTSTRAP_MODEL_CATALOG").is_some() {
