pub(super) use crate::alphacode_tui_style::theme::{
    ...
    rainbow_prompt_color, system_message_color, tool_color, user_bg, user_color,
    user_text,
};
#[cfg(test)]
pub(super) use crate::alphacode_tui_style::theme::{success_color, warning_color};
use ratatui::prelude::*;

pub(super) fn activity_indicator_frame_index(elapsed: f32, fps: f32) -> usize {
    crate::alphacode_tui_style::theme::activity_indicator_frame_index(
        elapsed,
        fps,
...
pub(super) fn activity_indicator(elapsed: f32, fps: f32) -> &'static str {
    crate::alphacode_tui_style::theme::activity_indicator(
        elapsed,
        fps,
        crate::perf::tui_policy().enable_decorative_animations,
    )
...
pub(super) fn animated_tool_color(elapsed: f32) -> Color {
    crate::alphacode_tui_style::theme::animated_tool_color(
        elapsed,
        crate::perf::tui_policy().enable_decorative_animations,
    )
}
