...
use crate::alphacode_tui_messages::{ImageRegion, ImageRegionRender, PreparedMessages};
...
pub(crate) struct AppExpandLevels<'a>(pub &'a dyn crate::alphacode_tui::tui::TuiState);
...
pub(crate) fn restage_requested_payloads(app: &dyn crate::alphacode_tui::tui::TuiState) {
...
fn prewarm_sender() -> &'static mpsc::SyncSender<PrewarmRequest> {
    PREWARM_TX.get_or_init(|| {
        ...
        if let Err(err) = std::thread::Builder::new()
            .name("alphacode-inline-image-prewarm".to_string())
...
impl AnchoredInlineImages {
    ...
    pub(crate) fn unplaced_items(
        &self,
        messages: &[crate::alphacode_tui_messages::DisplayMessage],
    ) -> Vec<InlineImageItem> {
        ...
        for msg in messages {
            use crate::alphacode_tui::tui::DisplayMessageRoleExt as _;
...
pub(crate) fn image_label_line(
    ...
    crate::alphacode_tui_render::truncate_line_preserving_suffix_to_width(
        &prefix,
        &Line::from(suffix),
        width as usize,
    )
...
fn image_fallback_note_line(width: u16) -> Line<'static> {
    crate::alphacode_tui_render::truncate_line_with_ellipsis_to_width(
...
pub(crate) fn build_section(
    ...
    let plain: Vec<String> = lines
        .iter()
        .map(crate::alphacode_tui_render::line_plain_text)
        .collect();
...
mod tests {
    ...
    fn build_section_emits_one_fit_region_per_image_with_label() {
        ...
        let label_line = crate::alphacode_tui_render::line_plain_text(&section.wrapped_lines[1]);
        assert!(
    ...
    fn visible_label_line_advertises_hide_badge() {
        ...
        let text = crate::alphacode_tui_render::line_plain_text(&line);
    ...
    fn generated_image_label_is_truncated_to_one_terminal_row() {
        ...
        generated.label = "/home/jeremy/alphacode/.alphacode/generated-images/1783707839145-ig_0c5e377de871aba5016a51388779588196944d98eff2c7aa30.png".to_string();
