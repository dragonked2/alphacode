...
//! [`crate::alphacode_tui_render::swarm_gallery`] module so the live TUI and the
...
use crate::alphacode_tui_render::swarm_gallery::{
...
pub(crate) fn render_swarm_chat_card_lines(
    ...
    crate::alphacode_tui_render::swarm_gallery::render_swarm_chat_cards(&gallery_members, width)
}
...
mod tests {
    use super::*;
    use crate::alphacode_tui_render::swarm_gallery::members_to_tiles;
