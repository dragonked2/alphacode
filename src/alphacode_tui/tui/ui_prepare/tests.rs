...
fn matching_suffix_len_detects_prepended_history() {
    use crate::alphacode_tui_messages::MessageBoundary;
...
fn auth_generation_change_invalidates_the_header_signature() {
    let before = crate::alphacode_base::auth::auth_status_generation();
    crate::alphacode_base::auth::bump_auth_status_generation_for_tests();
    let after = crate::alphacode_base::auth::auth_status_generation();
