...
fn handterm_native_latex_cell_symbol(source: &str, rows: u16, cols: u16) -> Option<String> {
    let apc = crate::alphacode_tui::tui::markdown::encode_handterm_latex_apc(source)?;
...
pub(crate) fn copy_badge_reserved_width(
    key: char,
    copy_badge_ui: &crate::alphacode_tui::tui::app::CopyBadgeUiState,
...
pub(super) fn draw_messages(
    ...
    if !crate::alphacode_tui::tui::mermaid::is_video_export_mode() {
    ...
    let pinned_diagrams = diagram_mode == crate::config::DiagramDisplayMode::Pinned;
    {
                ...
                if marker_visible {
                    ...
                    if render_height > 0 {
                        ...
                        let rows = if is_fit {
                            ...
                            if crate::alphacode_tui::tui::mermaid::render_image_widget_fit_stable(
                                hash,
                                image_area,
                                frame.buffer_mut(),
                                content_area.width,
                                ...
                                crate::alphacode_tui::tui::mermaid::render_image_widget_fit(
                                    hash,
                                    image_area,
                                    frame.buffer_mut(),
                                    centered,
                            ...
                            crate::alphacode_tui::tui::mermaid::render_image_widget(
                                hash,
                                image_area,
                                frame.buffer_mut(),
                                centered,
        ...
        if content_area.height > 0 {
            ...
            for region in &prepared.image_regions[band_start..band_end] {
                ...
                if region.render != crate::alphacode_tui_messages::ImageRegionRender::Fit {
                    continue;
                }
...
fn pinned_todo_band_lines(
    ...
    let msg = crate::alphacode_tui::tui::DisplayMessage::todos(payload.to_string());
...
mod tests {
    ...
    fn tail_follow_small_appends_snap_to_bottom() {
        ...
        crate::alphacode_tui::tui::ui::set_last_resolved_chat_scroll(100);
        let scroll = super::resolve_tail_follow_scroll(103, 30);
        assert_eq!(scroll, 103);
        assert!(!crate::alphacode_tui::tui::ui::tail_catchup_active());
    }
    ...
    fn tail_follow_large_append_slides_in_bounded_steps() {
        ...
        let mut guard = 0;
        while scroll < 112 {
            crate::alphacode_tui::tui::ui::set_last_resolved_chat_scroll(scroll);
    ...
    fn explicit_tail_follow_request_skips_content_catch_up_animation() {
        crate::alphacode_tui::tui::ui::set_last_resolved_chat_scroll(40);
        crate::alphacode_tui::tui::ui::request_tail_follow_snap();
