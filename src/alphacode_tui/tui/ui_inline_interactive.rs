...
fn picker_entry_display_name(entry: &crate::alphacode_tui::tui::PickerEntry) -> String {
...
fn picker_entry_pretty_name(entry: &crate::alphacode_tui::tui::PickerEntry) -> String {
    ...
    match crate::alphacode_tui::tui::app::helpers::model_names::pretty_known_model_family(base) {
...
fn model_picker_top_hint(picker: &crate::alphacode_tui::tui::InlineInteractiveState) -> Option<&'static str> {
    ...
    let is_runtime_model_picker = picker.kind == crate::alphacode_tui::tui::PickerKind::Model
        && picker
            .entries
            .iter()
...
fn picker_render_width(picker: &crate::alphacode_tui::tui::InlineInteractiveState, max_width: usize) -> usize {
    ...
    let model_cap = if picker.kind == crate::alphacode_tui::tui::PickerKind::Model {
        max_width
    } else if is_preview {
        42
    } else {
...
fn fuzzy_match_positions(pattern: &str, text: &str) -> Vec<usize> {
    crate::alphacode_fuzzy::fuzzy_match_positions(pattern, text)
}
...
mod tests {
    ...
    fn sample_picker() -> crate::alphacode_tui::tui::InlineInteractiveState {
        crate::alphacode_tui::tui::InlineInteractiveState {
            ...
            filter: String::new(),
            preview: false,
            entries: vec![crate::alphacode_tui::tui::PickerEntry {
    ...
    fn sample_agent_target_picker() -> crate::alphacode_tui::tui::InlineInteractiveState {
        crate::alphacode_tui::tui::InlineInteractiveState {
            kind: crate::alphacode_tui::tui::PickerKind::Model,
            filtered: vec![0],
            selected: 0,
    ...
    fn swarm_agent_model_picker_permanently_links_to_swarm_prompt_command() {
        ...
        for entry in &mut picker.entries {
            entry.action = crate::alphacode_tui::tui::PickerAction::AgentModelChoice {
                target: crate::alphacode_tui::tui::AgentModelTarget::Swarm,
