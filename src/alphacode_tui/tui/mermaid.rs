pub use crate::alphacode_tui_mermaid::{
...
pub fn install_alphacode_mermaid_hooks() {
    crate::alphacode_tui_mermaid::set_log_hooks(crate::logging::info, crate::logging::warn);
    crate::alphacode_tui_mermaid::set_render_completed_hook(|| {
        crate::bus::Bus::global().publish(crate::bus::BusEvent::MermaidRenderCompleted);
    });
    crate::alphacode_tui_mermaid::set_memory_snapshot_hook(|| {
        let snapshot = crate::process_memory::snapshot_with_source("client:mermaid:memory");
        crate::alphacode_tui_mermaid::ProcessMemorySnapshot {
