...
use crate::alphacode_tui_style::palette::{ALL_ROLES, Palette, Role, to_hex};
...
pub fn analyze_active() -> HarmonyReport {
    let background = if crate::alphacode_tui_style::theme_mode::is_light_theme() {
        (255, 255, 255)
    } else {
        (18, 18, 18)
    };
...
pub(crate) mod calibration {
    use super::*;
    use crate::alphacode_tui_style::palette::parse_hex;
