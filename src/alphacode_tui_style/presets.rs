...
pub const ALPHACODE: ThemeSeed = ThemeSeed {
    ...
    description: "Premium obsidian dark with electric teal accents and warm highlights",
    is_dark: true,
    fg: (230, 235, 248),
    fg_muted: (148, 160, 190),
    fg_subtle: (80, 90, 120),
    surface: (14, 18, 32),
    surface_alt: (24, 30, 52),
    border: (42, 50, 76),
    red: (255, 110, 120),
    orange: (255, 168, 100),
    yellow: (255, 215, 95),
...
pub const AURORA_PRO: ThemeSeed = ThemeSeed {
    ...
    is_dark: true,
    fg: (232, 236, 244),
    fg_muted: (155, 168, 190),
    fg_subtle: (96, 108, 132),
    surface: (14, 18, 30),
    surface_alt: (22, 28, 48),
    border: (44, 52, 78),
    red: (255, 118, 128),
    orange: (255, 172, 115),
    yellow: (242, 212, 118),
...
/// Ultra-dark obsidian with ice-blue highlights. Maximum depth, minimum
/// visual noise. The darkest theme in the collection — surfaces blend into
/// the bezel; only text and the single blue accent float above.
pub const OBSIDIAN: ThemeSeed = ThemeSeed {
    id: "obsidian",
    display_name: "Obsidian",
    description: "Ultra-dark with ice-blue highlights; maximum depth, minimum noise",
    is_dark: true,
    fg: (220, 228, 245),
    fg_muted: (128, 142, 170),
    fg_subtle: (68, 78, 105),
    surface: (8, 10, 18),
    surface_alt: (16, 20, 34),
    border: (34, 40, 62),
    red: (255, 100, 115),
    orange: (255, 160, 95),
    yellow: (250, 210, 100),
...
/// Midnight frost: deep navy base with frosted glass surfaces and a
/// cool-white accent. Designed for OLED screens where true blacks save
/// power; borders are kept to an absolute minimum for a seamless look.
pub const MIDNIGHT_FROST: ThemeSeed = ThemeSeed {
    id: "midnight-frost",
    display_name: "Midnight Frost",
    description: "Deep navy OLED dark with frosted glass surfaces and cool-white accent",
    is_dark: true,
    fg: (225, 232, 245),
    fg_muted: (140, 155, 185),
    fg_subtle: (72, 82, 112),
    surface: (10, 12, 22),
    surface_alt: (18, 22, 38),
    border: (38, 44, 68),
    red: (255, 108, 118),
    orange: (255, 165, 100),
    yellow: (248, 212, 105),
...
/// Ember glow: warm dark with amber-orange accent. The inverse of cool
/// themes — the entire palette leans warm for cozy, late-night coding
/// sessions where blue light is unwelcome.
pub const EMBER_GLOW: ThemeSeed = ThemeSeed {
    id: "ember-glow",
    display_name: "Ember Glow",
    description: "Warm dark with amber-orange accent; cozy late-night coding",
    is_dark: true,
    fg: (235, 225, 210),
    fg_muted: (165, 150, 130),
    fg_subtle: (95, 85, 72),
    surface: (20, 16, 14),
    surface_alt: (34, 28, 24),
    border: (58, 48, 40),
    red: (255, 105, 95),
    orange: (255, 160, 80),
    yellow: (255, 210, 85),
