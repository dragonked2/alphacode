...
use crate::alphacode_tui_style::palette::{Palette, Role};
...
pub fn generate_from_seed(seed: (u8, u8, u8), background: (u8, u8, u8)) -> Palette {
    ...
    // arbitrary angle. Fall back to alphacode's own blue so a gray seed yields a
...
mod generation {
    use super::*;
    use crate::alphacode_tui_style::harmony::{analyze, calibration};
    use crate::alphacode_tui_style::palette::ALL_ROLES;
