...
//!
//! Node weights and edges are *measured*, not declared: `alphacode-tui` renders real
...
use crate::alphacode_tui_style::harmony::Oklab;
...
/// The topology measured from alphacode's own rendered frames.
///
/// Regenerate with
/// `cargo test -p alphacode-tui --lib print_measured_palette_topology -- --ignored --nocapture`
...
///
/// Area weighting is the entire point. alphacode's default palette measures 0.10
