//! Client-server protocol for alphacode
//!
...
pub type ReloadRecoverySnapshot = crate::alphacode_selfdev_types::ReloadRecoveryDirective;
...
impl PlanGraphStatus {
    ...
    pub fn from_versioned_plan(
        ...
        let growth = crate::alphacode_plan::bridge::growth_stats(plan);
        ...
        Self {
            ...
            newly_ready_ids,
            low_confidence_ids: crate::alphacode_plan::bridge::low_confidence_completed_ids(plan),
