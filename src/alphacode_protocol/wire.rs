...
/// Mirrors `crate::alphacode_plan::dag::NodeSpec` but kept as an explicit wire type so the
...
pub enum Request {
    ...
    Reload {
        ...
        /// `alphacode server reload` can request a graceful upgrade without risking
    ...
    SetRoute {
        id: u64,
        selection: crate::alphacode_provider_core::RouteSelection,
    },
    ...
    SetCompactionMode {
        id: u64,
        mode: crate::alphacode_config_types::CompactionMode,
    },
    ...
    /// Send a task to alphacode agent
    ...
    /// Query alphacode agent's capabilities
...
pub enum ServerEvent {
    ...
    SidePaneImages {
        session_id: String,
        images: Vec<crate::alphacode_session_types::RenderedImage>,
    },
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<crate::alphacode_provider_core::ModelRoute>,
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        resolved_credential: Option<crate::alphacode_provider_core::ResolvedCredential>,
        ...
        #[serde(default)]
        compaction_mode: crate::alphacode_config_types::CompactionMode,
    ...
    CommListModelsResponse {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        model_routes: Vec<crate::alphacode_provider_core::ModelRoute>,
    },
