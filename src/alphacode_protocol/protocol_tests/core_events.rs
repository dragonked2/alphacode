...
fn test_history_event_decodes_without_compaction_mode_for_older_servers() -> Result<()> {
    ...
    assert_eq!(
        compaction_mode,
        crate::alphacode_config_types::CompactionMode::Reactive
    );
...
fn test_history_event_roundtrip_preserves_side_panel_snapshot() -> Result<()> {
    let event = ServerEvent::History {
        ...
        compaction_mode: crate::alphacode_config_types::CompactionMode::Reactive,
        activity: None,
        side_panel: crate::alphacode_side_panel_types::SidePanelSnapshot {
            focused_page_id: Some("page-1".to_string()),
            pages: vec![crate::alphacode_side_panel_types::SidePanelPage {
                id: "page-1".to_string(),
                title: "Notes".to_string(),
                file_path: "/tmp/notes.md".to_string(),
                format: crate::alphacode_side_panel_types::SidePanelPageFormat::Markdown,
                source: crate::alphacode_side_panel_types::SidePanelPageSource::Managed,
...
fn test_side_panel_state_event_roundtrip() -> Result<()> {
    let event = ServerEvent::SidePanelState {
        snapshot: crate::alphacode_side_panel_types::SidePanelSnapshot {
            focused_page_id: Some("page-1".to_string()),
            pages: vec![crate::alphacode_side_panel_types::SidePanelPage {
                id: "page-1".to_string(),
                title: "Notes".to_string(),
