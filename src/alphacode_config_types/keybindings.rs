...
//!
//! Historically alphacode used a single shared list of default keybindings for
...
pub const KEYBINDING_DEFAULTS: &[KeybindingDefault] = &[
    ...
    KeybindingDefault {
        id: "new_terminal",
        description: "Spawn a fresh alphacode session in a new terminal window",
        // Companion to the system-wide launch hotkey (Cmd+; / Alt+;): the
        // shifted variant spawns a new session from inside alphacode, reusing the
    ...
    KeybindingDefault {
        ...
        // Cmd+B is free in alphacode on macOS. On Windows/Linux, Ctrl+R is already
