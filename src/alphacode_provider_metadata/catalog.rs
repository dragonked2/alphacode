...
/// Dragonmeta — the local Alpha model served by the ember project's
/// `alpha serve` (a llama.cpp OpenAI-compatible server on 127.0.0.1:8080).
/// Keyless like Ollama/LM Studio: the server needs no API key, so
/// `requires_api_key` is false and the runtime uses the `direct-no-auth`
/// transport. The default model id is "alpha" (what the server reports for
/// the loaded Alpha GGUF); the live `/v1/models` catalog refresh adds the
/// exact served id alongside it.
pub const DRAGONMETA_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    id: "dragonmeta",
    display_name: "Dragonmeta",
    api_base: "http://127.0.0.1:8080/v1",
    api_key_env: "DRAGONMETA_API_KEY",
    env_file: "dragonmeta.env",
    setup_url: "https://github.com/dragonked2/alphacode#openai-compatible-providers",
    default_model: Some("alpha"),
    requires_api_key: false,
};

pub const GMICLOUD_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    id: "gmicloud",
    display_name: "GMI Cloud",
    api_base: "https://api.gmi-serving.com/v1",
    api_key_env: "GMICLOUD_API_KEY",
    env_file: "gmicloud.env",
    setup_url: "https://docs.gmicloud.ai/quickstart",
    default_model: Some("MiniMaxAI/MiniMax-M3"),
    requires_api_key: true,
};
...
pub const ZEROG_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    id: "zerog",
    display_name: "ZeroG",
    api_base: "https://router-api.0g.ai/v1",
    api_key_env: "ZEROG_API_KEY",
    env_file: "zerog.env",
    setup_url: "https://0g.ai",
    default_model: Some("qwen3.7-max"),
    requires_api_key: true,
};
...
/// through unchanged.
pub fn internal_model_display_name(model: &str) -> Option<&str> {
...
pub const AGENTROUTER_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    ...
    setup_url: "https://agentrouter.org/console/token",
    default_model: Some("gpt-5.5"),
    requires_api_key: true,
};

pub const TOKENROUTER_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    id: "tokenrouter",
    display_name: "TokenRouter",
    api_base: "https://api.tokenrouter.com/v1",
    api_key_env: "TOKENROUTER_API_KEY",
    env_file: "tokenrouter.env",
    setup_url: "https://www.tokenrouter.com/",
    default_model: Some("qwen/qwen3.8-max-free"),
    requires_api_key: true,
};
...
pub const OPENAI_COMPAT_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    ...
    api_base: "https://api.dmeta.me/v1",
...
pub const ALPHACODE_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "alphacode",
    display_name: "Alphacode Subscription",
    auth_kind: LoginProviderAuthKind::ApiKey,
    auth_state_key: LoginProviderAuthStateKey::Alphacode,
    auth_status_method: "API key",
    aliases: &["subscription", "alphacode-subscription"],
    menu_detail: "curated alphacode subscription models",
    recommended: false,
    target: LoginProviderTarget::Alphacode,
...
pub const GMICLOUD_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "gmicloud",
    display_name: "GMI Cloud",
    auth_kind: LoginProviderAuthKind::ApiKey,
    auth_state_key: LoginProviderAuthStateKey::OpenRouterLike,
    auth_status_method: "API key",
    aliases: &["gmi", "gmi-cloud", "gmicloud-ai"],
    menu_detail: "API key, free tier with MiniMax-M3",
    recommended: false,
    target: LoginProviderTarget::OpenAiCompatible(GMICLOUD_PROFILE),
    order: LoginProviderSurfaceOrder::new(Some(6), Some(6), Some(6), Some(6), Some(6)),
};
...
pub const ZEROG_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    ...
    auth_status_method: "API key",
    aliases: &["0g", "0gai"],
    menu_detail: "API key, 0G AI router",
    recommended: false,
    target: LoginProviderTarget::OpenAiCompatible(ZEROG_PROFILE),
...
pub const DRAGONMETA_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "dragonmeta",
    display_name: "Dragonmeta",
    auth_kind: LoginProviderAuthKind::Local,
    auth_state_key: LoginProviderAuthStateKey::OpenRouterLike,
    auth_status_method: "local endpoint",
    aliases: &["dragon", "dragon-meta", "dmeta"],
    menu_detail: "local Alpha serve endpoint (alpha serve)",
    recommended: false,
    target: LoginProviderTarget::OpenAiCompatible(DRAGONMETA_PROFILE),
    order: LoginProviderSurfaceOrder::new(Some(40), Some(40), Some(40), Some(40), Some(40)),
};

pub const TOKENROUTER_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "tokenrouter",
    display_name: "TokenRouter",
    auth_kind: LoginProviderAuthKind::ApiKey,
    auth_state_key: LoginProviderAuthStateKey::OpenRouterLike,
    auth_status_method: "API key",
    aliases: &["token-router", "tokenrouter-com"],
    menu_detail: "OpenAI-compatible API, free tier available",
    recommended: false,
    target: LoginProviderTarget::OpenAiCompatible(TOKENROUTER_PROFILE),
...
pub(crate) const LOGIN_PROVIDERS: [LoginProviderDescriptor; 57] = [
    ...
    ZAI_LOGIN_PROVIDER,
    KIMI_LOGIN_PROVIDER,
    GMICLOUD_LOGIN_PROVIDER,
    CHUTES_LOGIN_PROVIDER,
    ZEROG_LOGIN_PROVIDER,
