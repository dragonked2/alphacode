//! # alphacode-render-core
//!
//! Backend-neutral document/render model shared by alphacode's front-ends (the
...
//! (`alphacode-tui-markdown`); that renderer remains authoritative until this core
