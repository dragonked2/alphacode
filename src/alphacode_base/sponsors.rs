...
//! system prompt.
//! Some providers may share revenue with Alphacode when users choose their tools.
//! Partnership status never influences recommendations. The relationship is
//! disclosed in the UI with a link to <https://alphacode.sh/discovery-tools>.
//!
...
/// Public URL explaining Alphacode's tool-provider partnerships.
pub const DISCOVERY_PARTNERS_URL: &str = "https://alphacode.sh/discovery-tools";
