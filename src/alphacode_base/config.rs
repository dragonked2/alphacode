//! Configuration file support for alphacode
//!
//! Config is loaded from `~/.alphacode/config.toml` (or `$ALPHACODE_HOME/config.toml`)
//! Environment variables override config file settings.

pub use crate::alphacode_config_types::{
...
const CONFIG_ENV_KEYS: &[&str] = &[
    "HOME",
    "ALPHACODE_ACP_PROFILE",
    "ALPHACODE_ACP_TOOL_PROFILE",
    "ALPHACODE_ACTIVE_SESSIONS_MANAGER",
    "ALPHACODE_EXTERNAL_SESSIONS",
    "ALPHACODE_AMBIENT_ENABLED",
    "ALPHACODE_AMBIENT_MAX_INTERVAL",
    "ALPHACODE_AMBIENT_MIN_INTERVAL",
    "ALPHACODE_AMBIENT_MODEL",
    "ALPHACODE_AMBIENT_PROACTIVE",
    "ALPHACODE_AMBIENT_PROVIDER",
    "ALPHACODE_AMBIENT_VISIBLE",
    "ALPHACODE_ANIMATION_FPS",
    "ALPHACODE_AUTO_POKE",
    "ALPHACODE_AUTOJUDGE_ENABLED",
    "ALPHACODE_AUTOJUDGE_MODEL",
    "ALPHACODE_AUTOREVIEW_ENABLED",
    "ALPHACODE_AUTOREVIEW_MODEL",
    "ALPHACODE_AUTO_POKE",
    "ALPHACODE_AUTO_SERVER_RELOAD",
    "ALPHACODE_BING_API_KEY",
    "ALPHACODE_BING_API_KEY_ENV",
    "ALPHACODE_BING_MARKET",
    "ALPHACODE_CENTERED_TOGGLE_KEY",
    "ALPHACODE_CHAT_NATIVE_SCROLLBAR",
    "ALPHACODE_COMPACT_NOTIFICATIONS",
    "ALPHACODE_COPY_BADGE_ALT_LABEL",
    "ALPHACODE_COPY_SELECTION_TOGGLE_KEY",
    "ALPHACODE_COPILOT_PREMIUM",
    "ALPHACODE_CROSS_PROVIDER_FAILOVER",
    "ALPHACODE_DEBUG_SOCKET",
    "ALPHACODE_DEFAULT_REASONING_DISPLAY",
    "ALPHACODE_DICTATION_COMMAND",
    "ALPHACODE_DICTATION_KEY",
    "ALPHACODE_DICTATION_MODE",
    "ALPHACODE_DICTATION_TIMEOUT_SECS",
    "ALPHACODE_DIFF_LINE_WRAP",
    "ALPHACODE_DIFF_MODE",
    "ALPHACODE_DIFF_MODE_CYCLE_KEY",
    "ALPHACODE_DIAGRAM_PANE_TOGGLE_KEY",
    "ALPHACODE_DISABLE_BASE_TOOLS",
    "ALPHACODE_DISABLED_ANIMATIONS",
    "ALPHACODE_DISABLED_TOOLS",
    "ALPHACODE_DISCORD_BOT_TOKEN",
    "ALPHACODE_DISCORD_BOT_USER_ID",
    "ALPHACODE_DISCORD_CHANNEL_ID",
    "ALPHACODE_DISCORD_REPLY_ENABLED",
    "ALPHACODE_DISPLAY_CENTERED",
    "ALPHACODE_EFFORT_DECREASE_KEY",
    "ALPHACODE_EFFORT_INCREASE_KEY",
    "ALPHACODE_EMAIL_REPLY_ENABLED",
    "ALPHACODE_EMAIL_TO",
    "ALPHACODE_FOCUS_HOOK",
    "ALPHACODE_GATEWAY_BIND_ADDR",
    "ALPHACODE_GATEWAY_ENABLED",
    "ALPHACODE_GATEWAY_PORT",
    "ALPHACODE_HOME",
    "ALPHACODE_HOOK_PRE_TOOL",
    "ALPHACODE_HOOK_PRE_TOOL_TIMEOUT_MS",
    "ALPHACODE_HOOK_POST_TOOL",
    "ALPHACODE_HOOK_SESSION_END",
    "ALPHACODE_HOOK_SESSION_START",
    "ALPHACODE_HOOK_TURN_END",
    "ALPHACODE_HOOK_TURN_START",
    "ALPHACODE_IDLE_ANIMATION",
    "ALPHACODE_IMAP_HOST",
    "ALPHACODE_INFO_WIDGET_TOGGLE_KEY",
    "ALPHACODE_JADE_RELAY_API_BASE",
    "ALPHACODE_JADE_RELAY_ENABLED",
    "ALPHACODE_JADE_RELAY_LAUNCH_ENABLED",
    "ALPHACODE_JADE_RELAY_LAUNCH_WORKING_DIR",
    "ALPHACODE_JADE_RELAY_REPLY_ENABLED",
    "ALPHACODE_JADE_RELAY_SESSION_ID",
    "ALPHACODE_JADE_RELAY_TOKEN",
    "ALPHACODE_JADE_RELAY_TOKEN_ID",
    "ALPHACODE_JADE_RELAY_USER_ID",
    "ALPHACODE_KV_CACHE_MISS_NOTICES",
    "ALPHACODE_LATEX_RENDERING",
    "ALPHACODE_MARKDOWN_SPACING",
    "ALPHACODE_MEMORY_EMBEDDING_BACKEND",
    "ALPHACODE_MEMORY_EMBEDDING_BASE_URL",
    "ALPHACODE_MEMORY_EMBEDDING_DIM",
    "ALPHACODE_MEMORY_EMBEDDING_MODEL",
    "ALPHACODE_MEMORY_ENABLED",
    "ALPHACODE_ENABLE_MERMAID",
    "ALPHACODE_MEMORY_MODEL",
    "ALPHACODE_MEMORY_SIDECAR_ENABLED",
    "ALPHACODE_PERSIST_MEMORY_INJECTIONS",
    "ALPHACODE_MESSAGE_TIMESTAMPS",
    "ALPHACODE_MODEL",
    "ALPHACODE_MODEL_SWITCH_KEY",
    "ALPHACODE_MODEL_SWITCH_PREV_KEY",
    "ALPHACODE_MOUSE_CAPTURE",
    "ALPHACODE_NEW_TERMINAL_KEY",
    "ALPHACODE_NO_EMOJI",
    "ALPHACODE_NTFY_SERVER",
    "ALPHACODE_NTFY_TOPIC",
    "ALPHACODE_OPENAI_NATIVE_COMPACTION_MODE",
    "ALPHACODE_OPENAI_NATIVE_COMPACTION_THRESHOLD_TOKENS",
    "ALPHACODE_OPENAI_REASONING_EFFORT",
    "ALPHACODE_OPENAI_SERVICE_TIER",
    "ALPHACODE_OPENAI_TRANSPORT",
    "ALPHACODE_ANTHROPIC_REASONING_EFFORT",
    "ALPHACODE_PRESERVE_REASONING_CONTEXT",
    "ALPHACODE_PERFORMANCE",
    "ALPHACODE_PIN_IMAGES",
    "ALPHACODE_PIN_TODOS",
    "ALPHACODE_PREVENT_SLEEP_WHILE_STREAMING",
    "ALPHACODE_PROVIDER",
    "ALPHACODE_PROMPT_ENTRY_ANIMATION",
    "ALPHACODE_QUEUE_MODE",
    "ALPHACODE_REASONING_DISPLAY",
    "ALPHACODE_REDRAW_FPS",
    "ALPHACODE_SAME_PROVIDER_ACCOUNT_FAILOVER",
    "ALPHACODE_SCROLL_BOOKMARK_KEY",
    "ALPHACODE_SCROLL_DOWN_FALLBACK_KEY",
    "ALPHACODE_SCROLL_DOWN_KEY",
    "ALPHACODE_SCROLL_PAGE_DOWN_KEY",
    "ALPHACODE_SCROLL_PAGE_UP_KEY",
    "ALPHACODE_SCROLL_PROMPT_DOWN_KEY",
    "ALPHACODE_SCROLL_PROMPT_UP_KEY",
    "ALPHACODE_SCROLL_UP_FALLBACK_KEY",
    "ALPHACODE_SCROLL_UP_KEY",
    "ALPHACODE_SEARXNG_URL",
    "ALPHACODE_SHOW_AGENTGREP_OUTPUT",
    "ALPHACODE_SHOW_DIFFS",
    "ALPHACODE_SHOW_THINKING",
    "ALPHACODE_SIDE_PANEL_TOGGLE_KEY",
    "ALPHACODE_SIDE_PANEL_NATIVE_SCROLLBAR",
    "ALPHACODE_SMTP_PASSWORD",
    "ALPHACODE_SPAWN_HOOK",
    "ALPHACODE_STREAM_IDLE_TIMEOUT_SECS",
    "ALPHACODE_SWARM_ENABLED",
    "ALPHACODE_SWARM_MODEL",
    "ALPHACODE_SWARM_MAX_CONCURRENT_AGENTS",
    "ALPHACODE_SWARM_SPAWN_MODE",
    "ALPHACODE_SWARM_STRIP_LAYOUT",
    "ALPHACODE_TELEGRAM_BOT_TOKEN",
    "ALPHACODE_TELEGRAM_CHAT_ID",
    "ALPHACODE_TELEGRAM_REPLY_ENABLED",
    "ALPHACODE_TOOL_CALL_DETAILS",
    "ALPHACODE_TOOL_PROFILE",
    "ALPHACODE_TOOLS",
    "ALPHACODE_TRUSTED_EXTERNAL_AUTH_SOURCES",
    "ALPHACODE_TYPING_SCROLL_LOCK_TOGGLE_KEY",
    "ALPHACODE_UPDATE_CHANNEL",
    "ALPHACODE_WEBSEARCH_ENGINE",
    "ALPHACODE_WEBSEARCH_FALLBACK_ENGINES",
    "ALPHACODE_WORKSPACE_DOWN_KEY",
    "ALPHACODE_WORKSPACE_LEFT_KEY",
    "ALPHACODE_WORKSPACE_RIGHT_KEY",
    "ALPHACODE_WORKSPACE_UP_KEY",
    "XDG_CONFIG_HOME",
];
...
static CONFIG_CACHE: LazyLock<RwLock<ConfigCache>> = LazyLock::new(|| {
    ...
    // (e.g. copilot_premium -> ALPHACODE_COPILOT_PREMIUM), and fingerprinting
...
pub fn config() -> &'static Config {
    ...
    let config = {
        ...
        if cache.force_reload || cache.fingerprint != fingerprint {
            ...
            // (e.g. copilot_premium propagates config -> ALPHACODE_COPILOT_PREMIUM).
...
pub struct Config {
    ...
    /// Global "launch a new alphacode" hotkeys (macOS). Baked once by auto-import.
...
pub struct AcpConfig {
    ...
    pub profile: String,
    /// Tool profile to request when `alphacode acp` starts a daemon itself.
...
fn normalize_tool_name(name: &str) -> String {
    ...
    crate::alphacode_tool_types::resolve_tool_name(trimmed).to_string()
}
...
fn is_default_discovery_endpoint(endpoint: &str) -> bool {
    matches!(
        ...
        "https://api.alphacode.sh/v1/discovery" | "https://api.solosystems.dev/v1/discovery"
    )
}
