...
//! in the downstream `alphacode-provider-anthropic-runtime` crate so provider
...
pub use crate::alphacode_provider_core::CredentialMode as AnthropicCredentialMode;
