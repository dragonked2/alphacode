use super::*;
use crate::alphacode_provider_core::{FailoverDecision, ProviderFailoverPrompt};
...
impl MultiProvider {
    ...
    pub(super) fn fallback_sequence(active: ActiveProvider) -> Vec<ActiveProvider> {
        crate::alphacode_provider_core::fallback_sequence(active)
    }
    ...
    pub(super) fn classify_failover_error(err: &anyhow::Error) -> FailoverDecision {
        crate::alphacode_provider_core::classify_failover_error_message(&err.to_string())
    }
