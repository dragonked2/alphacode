...
use crate::alphacode_message_types::{Message, stable_message_hash};
    ...
    fn prefix_hashes_for_messages(messages: &[Message]) -> Vec<u64> {
        ...
        for message in messages {
            ...
            let prefix_hash = prefix_hashes
                .last()
                .copied()
                .map(|prev| crate::alphacode_message_types::extend_stable_hash(prev, message_hash))
...
mod tests {
    use super::*;
    use crate::alphacode_message_types::{ContentBlock, Role};
