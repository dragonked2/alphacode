---
name: ctf-writeup
description: CTF writeup generator — authorized educational environment covering standardized submission-style writeups with metadata, solution steps, and reproducible scripts.
license: MIT
---

# CTF Writeup — Authorized Educational Environment
