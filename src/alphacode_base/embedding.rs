//! Embedding facade for alphacode.
//!
//! The heavy ONNX/tokenizer implementation lives in the `alphacode-embedding`
...
pub fn models_dir() -> Result<PathBuf> {
    let dir = alphacode_dir()?.join("models").join(backend::MODEL_NAME);
