...
mod tests {
    ...
    fn verify_run_command() {
        let args =
            Args::try_parse_from(["alphacode", "run", "hello"]).unwrap();
    ...
    fn verify_provider_flag() {
        let args =
            Args::try_parse_from(["alphacode", "--provider", "openai"]).unwrap();
    ...
    fn verify_model_flag() {
        let args =
            Args::try_parse_from(["alphacode", "--model", "gpt-4"]).unwrap();
    ...
    fn verify_resume_flag() {
        let args =
            Args::try_parse_from(["alphacode", "--resume"]).unwrap();
    ...
    fn verify_telemetry_command() {
        let args =
            Args::try_parse_from(["alphacode", "telemetry", "status"]).unwrap();
