...
/// and Apple Terminal; see issue #330 and `crate::alphacode_tui_style::color`). Capping
...
/// in `crate::alphacode_tui_style::color::fragile_glyph_cache_terminal`. Overridable with
