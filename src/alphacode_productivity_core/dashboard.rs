...
use crate::alphacode_productivity_core::markdown::human;
use crate::alphacode_productivity_core::model::ProductivityReport;
...
pub fn render_svg(r: &ProductivityReport) -> String {
    ...
    // ---- Header ----
    svg.text(pad, 92.0, "alphacode", 30.0, ACCENT, 800, "start");
    ...
    svg.text(
        W - pad,
        H - 30.0,
        "generated with alphacode  ·  /productivity",
        16.0,
        ACCENT,
        600,
        "end",
