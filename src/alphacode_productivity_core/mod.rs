//! Productivity report generation for alphacode.
//!
...
/// PNG to `~/.alphacode/generated-images/productivity-<timestamp>.png`.
...
fn save_png(png: &[u8]) -> Result<PathBuf> {
    let dir = crate::alphacode_storage::alphacode_dir()?.join("generated-images");
